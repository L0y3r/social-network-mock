    ...
    <div className="min-h-screen bg-gradient-to-br from-purple-100 to-pink-100 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-2xl mx-auto bg-white rounded-xl shadow-md p-8">
        ...
        <p className="text-gray-700 text-lg mb-8">
          Just had the most amazing coffee at a new cafe downtown! ☕️ The
          atmosphere was so cozy, and the latte art was incredible. Definitely
          coming back soon.
        </p>
          ...
          <div className="flex space-x-2">
            ...
            <button className="flex items-center text-gray-600 hover:text-purple-600">
              ...
              >
                <path
                  fillRule="evenodd"
                  d="M18 13H6a3 3 0 01-3-3V5a3 3 0 013-3h12a3 3 0 013 3v5a3 3 0 01-3 3zM5 10a1 1 0 011-1h8a1 1 0 110 2H6a1 1 0 01-1-1z"
                  clipRule="evenodd"
                />
              </svg>
              <span>4</span>
