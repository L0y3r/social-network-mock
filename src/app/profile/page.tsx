    ...
    <div className="space-y-6">
      <div className="flex flex-col items-center">
        <div className="relative">
          <Image className="h-24 w-24 rounded-full object-cover border-4 border-pink-300" src="https://placehold.co/200" width={200} height={200} alt="Profile picture" />
          <div className="absolute bottom-0 right-0 p-1 bg-pink-500 rounded-full text-white">
            <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor">
              <path fillRule="evenodd" d="M4 5a2 2 0 00-2 2v8a2 2 0 002 2h12a2 2 0 002-2V7a2 2 0 00-2-2H4zm11 5a1 1 0 11-2 0 1 1 0 012 0zm-1-4a1 1 0 10-2 0 1 1 0 002 0z" clipRule="evenodd" />
            </svg>
          </div>
        </div>
      ...
      <div className="border-t border-gray-200 pt-4">
        ...
        <div className="mb-4">
          ...
          <p className="mt-1 text-sm text-gray-900">Passionate about building innovative web applications.</p>
        </div>
      </div>
